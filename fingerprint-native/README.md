...
- `preview` - Uses the cached "last preview commit" to compare the current commit against
...
## Updating the `preview` commit cache

Once a new preview client has been successfully built by GitHub, you should update the cache
